...
<div class="flex justify-center mt-20 px-8">
    <form class="max-w-2xl" enctype="multipart/form-data" method="post" action="{{route('admin.update.profile')}}">
        @csrf
        <div class="space-y-12">
            <div class="border-b border-gray-900/10 pb-12">
              <h2 class="text-base font-semibold leading-7 text-gray-900"> My Profile</h2>
              <p class="mt-1 text-sm leading-6 text-gray-900">User : {{Auth::user()->name}}</p>
              <p class="mt-1 text-sm leading-6 text-gray-900">Profile : {{Auth::user()->role}}</p>
              ...
              <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                ...
                <div class="col-span-full">
                  ...
                  <div class="flex rounded-md shadow-sm ring-1 ring-inset ring-gray-300 focus-within:ring-2 focus-within:ring-inset focus-within:ring-indigo-600 sm:max-w-md">
                    <input type="text" name="phone" value="{{Auth::user()->phone}}" id="number" class="block flex-1 border-0 bg-transparent py-1.5 pl-1 text-gray-900 placeholder:text-gray-400 focus:ring-0 sm:text-sm sm:leading-6" placeholder="697004863">
                  </div>
                </div>
                ...
                <div class="col-span-full">
                  ...
                  <div class="mt-2 flex justify-center rounded-lg border border-dashed border-gray-900/25 px-6 py-10">
                    <div class="text-center">
                        ...
                        @else
                            <svg class="mx-auto h-12 w-12 text-gray-900" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
